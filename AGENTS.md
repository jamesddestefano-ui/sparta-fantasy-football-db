...
14. Sparta FAAB dollars are real dollars. There is no separate pickup transaction fee. After the Sep. 15, 2026 Week 2 FAAB run, every pickup going forward requires a minimum $1 FAAB bid; a waiver acquisition costs only its winning FAAB bid. Week 1/pre-transition pickups may have $0 FAAB cost. Use the current real-money FAAB balance stored here.
...
50. There is no separate transaction fee. After the Sep. 15 Week 2 FAAB transition, every completed Sparta pickup costs at least $1 because $1 is the minimum FAAB bid and FAAB dollars are real dollars. Learning reviews must evaluate FAAB efficiency and cumulative churn using actual winning FAAB paid.
